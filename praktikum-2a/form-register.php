...
<?php
require_once "data-register.php"
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Maula Fathan Gibran Lubis" type="text" class="form-control" required="required" minlengt="3" maxlenght="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
